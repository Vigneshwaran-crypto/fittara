...
import tshirt from "../../../Assets/enhanced/tshirt.glb";
...
const Enhancer = () => {
  ...
  useEffect(() => {
    sessionStorage.setItem("curPath", "/enhancer");
    getAppNodeAndMat();
  }, []);
  ...
  const getAppNodeAndMat = () => {
    console.log("Tshirt Nodes&materials :", shirtMd);
  ...
  const DirectLight = ({ position, rotation = [0, 0, 0], intensity }) => {
  ...
  const HemLight = ({ position, rotation = [0, 0, 0], intensity }) => {
    const lightRef = useRef();
